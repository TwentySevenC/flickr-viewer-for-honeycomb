...
public class MainNavFragment extends Fragment {
    ...
    protected void handleUserPanel(View view) {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder
                        .setMessage(
                                getActivity().getResources().getString(R.string.logout_msg))
                        .setCancelable(false)
                        .setPositiveButton(
                                getActivity().getResources().getString(R.string.btn_yes),
                        ...
                        .setNegativeButton(getActivity().getResources().getString(R.string.btn_no),
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                            int id) {
                                        dialog.cancel();
    ...
    private List<CommandItem> createNavCommandItems() {
        ...
        item.title = getActivity().getResources().getString(R.string.item_interesting_photo);
        list.add(item);

        item = new CommandItem();
        item.imageResId = R.drawable.photos;
        item.title = getActivity().getResources().getString(R.string.item_my_photo);
        list.add(item);

        item = new CommandItem();
        item.imageResId = R.drawable.contacts;
        item.title = getActivity().getResources().getString(R.string.item_my_contact);
        list.add(item);

        item = new CommandItem();
        item.imageResId = R.drawable.myfavorite;
        item.title = getActivity().getResources().getString(R.string.item_my_fav);
        list.add(item);

        item = new CommandItem();
        item.imageResId = R.drawable.activities;
        item.title = getActivity().getResources().getString(R.string.item_recent_activities);
        list.add(item);

        item = new CommandItem();
        item.imageResId = R.drawable.settings;
        item.title = getActivity().getResources().getString(R.string.item_settings);
        list.add(item);
